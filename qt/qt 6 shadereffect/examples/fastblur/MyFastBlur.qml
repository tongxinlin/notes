...
Item {
    ...
    /*! \internal */
    property string __internalBlurVertexShader: cppUtilities.isQt6OrAbove()
                                                ? "qrc:/fastblur_internal.vert.qsb"
                                                : "qrc:/fastblur_internal.vert"

    /*! \internal */
    property string __internalBlurFragmentShader: cppUtilities.isQt6OrAbove()
                                                  ? "qrc:/fastblur_internal.frag.qsb"
                                                  : "qrc:/fastblur_internal.frag"
    ...
    ShaderEffect {
        ...
        fragmentShader: cppUtilities.isQt6OrAbove()
                        ? "qrc:/fastblur.frag.qsb"
                        : "qrc:/fastblur.frag"
    }
}
